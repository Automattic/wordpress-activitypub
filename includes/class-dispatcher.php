...
class Dispatcher {
	...
	public static function init() {
		...
		\add_filter(
			...
			function ( $inboxes, $actor_id, $activity ) {
				 ...
				 *
				 * @deprecated 5.1.2 Use `activitypub_interactees_inboxes` instead.
				 */
				return \apply_filters_deprecated( 'activitypub_send_to_inboxes', array( $inboxes, $actor_id, $activity ), '5.1.2', 'activitypub_interactees_inboxes' );
			},
			10,
			3
		);
	 ...
	 *
	 * @deprecated 5.1.2 Use {@see Followers::maybe_add_inboxes_of_blog_user} instead.
	 *
	 * @param array    $inboxes  The list of Inboxes.
	 * @param int      $actor_id The WordPress Actor-ID.
	 * @param Activity $activity The ActivityPub Activity.
	...
	public static function maybe_add_inboxes_of_blog_user( $inboxes, $actor_id, $activity ) { // phpcs:ignore
		_deprecated_function( __METHOD__, '5.1.2', 'Followers::maybe_add_inboxes_of_blog_user' );
