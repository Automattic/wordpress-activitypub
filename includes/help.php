	...
	array(
		...
		'content' =>
			...
			'<dl>' .
				...
				'<dd>' . \wp_kses( __( 'The post\'s content. With <code>apply_filters</code> you can decide if WordPress\' content filters (`the_content`) should be applied or not (default is <code>yes</code>). The values can be <code>yes</code> or <code>no</code>. <code>apply_filters</code> attribute is optional.', 'activitypub' ), 'default' ) . '</dd>' .
