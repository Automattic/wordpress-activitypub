...
class Admin {
	...
	/**
	 * Load user mentions page
	 */
	public static function mentions_list_page() {
		\load_template( \dirname( __FILE__ ) . '/../templates/mentions-list.php' );
	}
	...
	public static function add_mentions_list_help_tab() {
		// todo
	}
