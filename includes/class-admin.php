...
class Admin {
	...
	public static function admin_menu() {
		...
		$followers_list_page = \add_users_page( \__( 'ActivityPub', 'activitypub' ), \__( 'ActivityPub', 'activitypub' ), 'read', 'activitypub-followers-list', array( '\Activitypub\Admin', 'followers_list_page' ) );
