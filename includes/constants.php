...
defined( 'ACTIVITYPUB_OUTBOX_RETRY_MAX_ATTEMPTS' ) || define( 'ACTIVITYPUB_OUTBOX_RETRY_MAX_ATTEMPTS', 3 );
defined( 'ACTIVITYPUB_OUTBOX_RETRY_DELAY_UNIT' ) || define( 'ACTIVITYPUB_OUTBOX_RETRY_DELAY_UNIT', HOUR_IN_SECONDS );
defined( 'ACTIVITYPUB_ASYNC_BATCH_PAUSE' ) || define( 'ACTIVITYPUB_ASYNC_BATCH_PAUSE', 30 );
