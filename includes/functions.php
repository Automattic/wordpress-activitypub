 ...
 *
 * This is a wrapper around is_plugin_active() that ensures the function
 * is available by loading wp-admin/includes/plugin.php if needed. This is
 * useful when checking plugin status outside of the admin context.
 *
 * @param string $plugin Plugin basename (e.g., 'plugin-folder/plugin-file.php').
 *
 * @return bool True if the plugin is active, false otherwise.
 */
function is_plugin_active_with_fallback( $plugin ) {
