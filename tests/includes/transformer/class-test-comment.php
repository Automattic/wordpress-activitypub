...
class Test_Comment extends \WP_UnitTestCase {
	...
	public function test_content_with_reply_context() {
		...
		$this->assertSame( '<p><a rel="mention" class="u-url mention" href="https://example.net/@remote">@remote</a> <a rel="mention" class="u-url mention" href="https://remote.example/@author">@author</a> This is a comment</p>', $content );
