...
function keyMax( l: number, h: number, gamut: 'p3' | 'srgb', cap: number ): string {
...
function getCachedMaxChromaAtLH( l: number, h: number, gamutSpace: typeof P3 | typeof sRGB, cap: number ): number {
 ...
 * @param cap
 */
function maxInGamutChromaAtLH( l: number, h: number, gamutSpace: typeof P3 | typeof sRGB, cap: number ): number {
	let lo = 0;
	let hi = cap;
	let ok = 0;
