...
import type { RampResult as InternalRampResult, RampDirection, Ramp } from './lib/types';
 ...
 */
export function buildAccentRamp( seed: string, bgRamp?: InternalRampResult ): InternalRampResult {
	if ( typeof seed !== 'string' || seed.trim() === '' ) {
		throw new Error( 'Seed color must be a non-empty string' );
	}
