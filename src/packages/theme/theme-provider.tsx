...
function generateCSSSelector( { instanceId, isRoot }: { instanceId: string; isRoot: boolean } ) {
	...
	if ( isRoot ) {
		selectors.push( `:root:has(.${ styles.root }${ rootSel }${ instanceIdSel })` );
	}
...
export const ThemeProvider = ( { children, color = {}, isRoot = false }: ThemeProviderProps ) => {
