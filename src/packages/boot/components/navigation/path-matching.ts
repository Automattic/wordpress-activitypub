 ...
 */
const isValidParentPath = ( currentPath: string, menuPath: string ): boolean => {
 ...
 */
export const findClosestMenuItem = ( currentPath: string, menuItems: MenuItem[] ): MenuItem | null => {
 ...
 */
export const findDrilldownParent = ( id: string | undefined, menuItems: MenuItem[] ): string | undefined => {
	if ( ! id ) {
		return undefined;
	}
 ...
 */
export const findDropdownParent = ( id: string | undefined, menuItems: MenuItem[] ): string | undefined => {
	if ( ! id ) {
		return undefined;
	}
