...
export default function DropdownItem( { className, id, icon, children, isExpanded, onToggle }: DropdownItemProps ) {
				...
				{ isExpanded && (
					...
					>
						{ items.map( ( item, index ) => (
							<NavigationItem key={ index } to={ item.to } shouldShowPlaceholder={ false }>
								{ item.label }
							</NavigationItem>
						) ) }
					</motion.div>
