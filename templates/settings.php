					...
					<tr>
						...
						<td>
							<label for="activitypub_blog_user_identifier">
								<input class="blog-user-identifier" name="activitypub_blog_user_identifier" id="activitypub_blog_user_identifier" type="text" value="<?php echo esc_attr( \get_option( 'activitypub_blog_user_identifier', \Activitypub\Activity\Actor::get_default_username() ) ); ?>" />
