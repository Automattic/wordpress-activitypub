 ...
 */
function render_fasp_registration_card( $registration, $status, $highlighted = false ) {
	...
	<?php if ( ! empty( $pending_registrations ) ) : ?>
		...
		<div class="fasp-registrations-pending">
			<?php foreach ( $pending_registrations as $registration ) : ?>
				<?php render_fasp_registration_card( $registration, 'pending', $highlighted_id === $registration['fasp_id'] ); ?>
			<?php endforeach; ?>
		</div>
	<?php endif; ?>
	...
	<?php if ( ! empty( $approved_registrations ) ) : ?>
		...
		<div class="fasp-registrations-approved">
			<?php foreach ( $approved_registrations as $registration ) : ?>
				<?php render_fasp_registration_card( $registration, 'approved' ); ?>
			<?php endforeach; ?>
		</div>
	<?php endif; ?>
