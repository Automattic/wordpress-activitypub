...
<p><?php esc_html_e( 'For more information please visit', 'activitypub' ); ?> <a href="https://fediverse.party/" target="_blank">fediverse.party</a></p>
...
<?php
echo wp_kses(
	__( 'For more information please visit <a href="https://webfinger.net/" target="_blank">webfinger.net</a>', 'activitypub' ),
	array(
		'a' => array(
			'href'   => true,
			'target' => true,
...
<?php
echo wp_kses(
	__( 'For more information please visit <a href="http://nodeinfo.diaspora.software/" target="_blank">nodeinfo.diaspora.software</a>', 'activitypub' ),
	array(
		'a' => array(
			'href'   => true,
			'target' => true,
