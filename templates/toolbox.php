<div class="card activitypub">
	...
	<form>
		...
		<p><?php esc_html_e( 'Save this bookmarklet to reply to posts on other sites from your own blog! When visiting a post on another site, click the bookmarklet to start a reply.', 'activitypub' ); ?></p>
		<p class="activitypub-bookmarklet-wrapper">
			<a class="activitypub-bookmarklet button" onclick="return false;" href="<?php echo esc_html( \Activitypub\get_reply_intent_uri() ); ?>">
		...
		<div class="activitypub-code-wrap clear" id="activitypub-code-wrap">
			...
			<p><span class="dashicons dashicons-clipboard"></span> <a href="javascript:;" class="copy-activitypub-bookmarklet-code"><?php esc_html_e( 'Copy code to clipboard', 'activitypub' ); ?></a></p>
		</div>
		<script>
