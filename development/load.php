...
\add_filter( 'http_request_args', '\Activitypub\Development\allow_localhost' );
...
\add_filter( 'register_post_type_args', '\Activitypub\Development\debug_outbox_post_type', 10, 2 );
...
\add_filter( 'manage_posts_columns', '\Activitypub\Development\debug_outbox_post_type_column', 10, 2 );
...
\add_action( 'manage_posts_custom_column', '\Activitypub\Development\manage_posts_custom_column', 10, 2 );
