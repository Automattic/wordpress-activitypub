...
| Integration | What it does |
|---|---|
| **Jetpack** | Syncs ActivityPub options and follower/following meta to WordPress.com, adds a Reader link on the Following screen, enables the Following UI, adapts the "share to reply" flow, and federates Jetpack podcast episodes with their audio enclosure and cover art. |
