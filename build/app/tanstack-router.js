  ...
  constructor(options) {
    ...
    this.parseLocation = (locationToParse, previousLocation) => {
      const parse = ({
        ...
        return {
          ...
          publicHref: href,
          url: url.href,
          pathname: (0,_utils_js__WEBPACK_IMPORTED_MODULE_3__.decodePath)(pathname),
          searchStr,
    ...
    this.beforeLoad = () => {
      ...
      if (this.isServer) {
        ...
        if ((0,_path_js__WEBPACK_IMPORTED_MODULE_5__.trimPath)(normalizeUrl(this.latestLocation.href)) !== (0,_path_js__WEBPACK_IMPORTED_MODULE_5__.trimPath)(normalizeUrl(nextLocation.href))) {
