...
/* harmony import */ var _components_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../components/page */ "./src/social-web/components/page/index.tsx");
/* harmony import */ var _hooks_use_feed__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../hooks/use-feed */ "./src/social-web/hooks/use-feed.ts");
/* harmony import */ var _components_fields__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../components/fields */ "./src/social-web/components/fields/index.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./utils */ "./src/social-web/routes/feed/utils.ts");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../store */ "./src/social-web/store/index.ts");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./style.scss */ "./src/social-web/routes/feed/style.scss");
...
function FeedStage({
  ...
  const activeActorId = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => select(_store__WEBPACK_IMPORTED_MODULE_10__.STORE_NAME).getActiveActorId(), []);
  ...
  const {
    ...
    totalItems,
    totalPages
  } = (0,_hooks_use_feed__WEBPACK_IMPORTED_MODULE_7__.useFeed)({
  ...
  const fields = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => [_components_fields__WEBPACK_IMPORTED_MODULE_8__.metadataField, _components_fields__WEBPACK_IMPORTED_MODULE_8__.titleField, _components_fields__WEBPACK_IMPORTED_MODULE_8__.contentField, _components_fields__WEBPACK_IMPORTED_MODULE_8__.dateField, _components_fields__WEBPACK_IMPORTED_MODULE_8__.objectTypeField, _components_fields__WEBPACK_IMPORTED_MODULE_8__.tagField], []);

  // Normalize view.fields to maintain the canonical order defined in fields array
  const normalizedView = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => (0,_utils__WEBPACK_IMPORTED_MODULE_9__.normalizeFieldOrder)(view, fields), [view, fields]);
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_page__WEBPACK_IMPORTED_MODULE_6__.Page, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Feed', 'activitypub'),
    subTitle: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('ActivityPub posts from your network', 'activitypub'),
    hasPadding: false,
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_wordpress_dataviews__WEBPACK_IMPORTED_MODULE_1__["default"], {
